...
#include "Projekt_Studia/Variant_SideScrolling/AI/SideScrollingStateTreeUtility.h"
...
PROJEKT_STUDIA_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData();
PROJEKT_STUDIA_API UScriptStruct* Z_Construct_UScriptStruct_FStateTreeGetPlayerTask();
...
class UScriptStruct* FStateTreeGetPlayerInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData, (UObject*)Z_Construct_UPackage__Script_Projekt_Studia(), TEXT("StateTreeGetPlayerInstanceData"));
	}
...
class UScriptStruct* FStateTreeGetPlayerTask::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateTreeGetPlayerTask, (UObject*)Z_Construct_UPackage__Script_Projekt_Studia(), TEXT("StateTreeGetPlayerTask"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Projekt_Studia_Source_Projekt_Studia_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_Projekt_Studia_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FStateTreeGetPlayerInstanceData::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerInstanceData_Statics::NewStructOps, TEXT("StateTreeGetPlayerInstanceData"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerInstanceData), 479009360U) },
		{ FStateTreeGetPlayerTask::StaticStruct, Z_Construct_UScriptStruct_FStateTreeGetPlayerTask_Statics::NewStructOps, TEXT("StateTreeGetPlayerTask"), &Z_Registration_Info_UScriptStruct_FStateTreeGetPlayerTask, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateTreeGetPlayerTask), 541597307U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projekt_Studia_Source_Projekt_Studia_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_Projekt_Studia_576232722(TEXT("/Script/Projekt_Studia"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Projekt_Studia_Source_Projekt_Studia_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_Projekt_Studia_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projekt_Studia_Source_Projekt_Studia_Variant_SideScrolling_AI_SideScrollingStateTreeUtility_h__Script_Projekt_Studia_Statics::ScriptStructInfo),
	nullptr, 0);
// ********** End Registration *********************************************************************
